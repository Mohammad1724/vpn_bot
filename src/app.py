...
def build_application():
    ...
    charge_conv = ConversationHandler(
        entry_points=[
            # ساده و مقاوم: هر پیامی که شامل ایموجی 💳 باشد
