...
# --- بلوک بررسی متغیرهای محیطی (نسخه بهبود یافته) ---
...
def handle_receipt(message):
    ...
    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton("✅ تایید و شارژ", callback_data=f"approve_charge_{user_id}_{requested_amount}"))
